...
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.setMedialLink=_exports.setLink=void 0,_templates=_interopRequireDefault(_templates),_pending=_interopRequireDefault(_pending);_exports.setLink=(preid,inserttype,editor)=>{var xmlDoc=new XMLHttpRequest,params="resource_link_id="+preid+"&user_id="+(0,_options.getUserId)(editor)+"&oauth_consumer_key="+(0,_options.getOauthConsumerKey)(editor)+"&context_id="+(0,_options.getCourse)(editor)+"&include_height=Y";xmlDoc.onload=response=>{const pendingPromise=new _pending.default("tiny_medial/setLink");checkResponse(preid,inserttype,editor,response).then(pendingPromise.resolve).catch((error=>{console.log(error)}))},window.console.log((0,_options.getPlayerSizeUrl)(editor)),xmlDoc.open("POST",(0,_options.getPlayerSizeUrl)(editor),!0),xmlDoc.setRequestHeader("Content-type","application/x-www-form-urlencoded"),xmlDoc.send(params)};const checkResponse=async(preid,inserttype,editor,response)=>{if(!(response.target.status<200&&response.target.status>=400)){var resp=response.target.responseText.split(":"),audioonly=0;3==resp.length&&"Y"==resp[2]&&(audioonly=1),window.console.log("audioonly="+audioonly);var template="";template=(0,_options.getLinkOnly)(editor)||"iframe"!=inserttype?"tiny_medial/link":"tiny_medial/iframe",setMedialLink(preid,inserttype,editor,audioonly,(0,_options.getViewLaunchType)(editor),template)}},setMedialLink=async(preid,inserttype,editor,audioonly,launchtype,template)=>{var context={url:getEmbedUrl(editor)+"?type="+launchtype+"&responsive=1&medialembed="+inserttype+"&audioonly="+audioonly+"&l="+preid,bs5:(0,_options.getBs5)(editor)};1==audioonly&&(context.audioonly=!0);const{html:html}=await _templates.default.renderForPromise(template,context);window.console.log(html),editor.insertContent(html)};_exports.setMedialLink=setMedialLink;const getEmbedUrl=editor=>1==(0,_options.getPlaceholder)(editor)?"{{{medial_launch_base}}}/mod/helixmedia/launch.php":(0,_options.getBaseurl)(editor)+"/mod/helixmedia/launch.php"}));
