...
$string['internal_desc'] = 'TinyMCE file insert options for internal and external files are sometimes hidden by Moodle. MEDIAL is defined as an external file. however there may be a small number of cases where MEDIAL is wanted in a location that only allows internal file. Switching this option on will allow MEDIAL to be used where only internal files are allow.';
